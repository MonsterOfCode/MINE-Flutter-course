...
import 'package:shopping2/models/product_details.model.dart';
import 'package:shopping2/repositories/product.repository.dart';
        ...
        switch (snapshot.connectionState) {
          ...
          case ConnectionState.done:
            if (snapshot.hasError)
              return Center(
                child: Text("Product unavailable for now"),
              );
